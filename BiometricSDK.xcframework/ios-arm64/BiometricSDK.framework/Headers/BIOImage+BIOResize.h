...
/// Method to convert BIOImage to JPEG file with default compression quality.
- (NSData *)toJPEG;

/// Method to convert BIOImage to JPEG file with given compression quality.
/// @param quality Compression quality in range [0, 1].
