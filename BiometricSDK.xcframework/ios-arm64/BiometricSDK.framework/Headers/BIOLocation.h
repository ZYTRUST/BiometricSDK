...
/**
 *   Flag is set if biometric is right thum
 */
extern const BIOLocation BIOLocationFingerRightThumb;

/**
 *   Flag is set if biometric is left thum
 */
extern const BIOLocation BIOLocationFingerLeftThumb;
